...
class WindowT(Screen):
    def __init__(self, name='window_triangle'):
        ...
        self.bar_1 = ProgressBar(value=self.value, max=4)
        self.bar_2 = ProgressBar(value=self.value, max=7)
        self.bar_3 = ProgressBar(value=self.value, max=8)
    ...
    def timer(self):
        self.bar_1_lab_1.text = f'{self.lab_1_text}: 4'
        self.bar_2_lab_2.text = f'{self.lab_2_text}: 7'
        self.bar_3_lab_3.text = f'{self.lab_3_text}: 8'
        ...
        self.cl_3 = Clock.schedule_interval(self.cl_3_1, 11)
    ...
    def music_fan(self, df):
        self.music_1.play()
        self.cl_music_1.cancel()
        self.cl_music_1 = Clock.schedule_interval(self.music_fan_1, 7)

    def music_fan_1(self, df):
        self.music_1.play()
        self.cl_music_1.cancel()
        self.cl_music_1 = Clock.schedule_interval(self.music_fan_2, 8)
